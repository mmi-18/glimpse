...
export function ProfileContentGrid({
  ...
  const basePortfolio = useMemo(
    () => buildPortfolioCells({ profile, posts, displayName: user.display_name }),
    [profile, posts, user.display_name],
  );
    ...
    <section>
      ...
      >
        <SpanGrid
          ...
          renderCell={(cell) => (
            <ProfileCellRenderer cell={cell as GridCell<ProfileCellData>} />
          )}
        />
      </div>
      {editing && (
